...
```
## OUTPUT:
<img width="786" height="175" alt="image" src="https://github.com/user-attachments/assets/1369e1b9-d4d2-447f-aeaf-c19cf729672a" />

## RESULT:
The host took 16 seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in ________ seconds. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
